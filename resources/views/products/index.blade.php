        ...
        <div class="col-md-12">
            ...
            <div class="card mb-4">
                <div class="card-header">
                    <h6 class="mb-0">
                        <i class="fas fa-folder text-warning"></i> Управление категориями
                    </h6>
                </div>
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-4 text-md-end">
                            <a href="{{ route('bot.categories.index', $telegramBot) }}" class="btn btn-warning btn-sm me-2">
            ...
            <div class="card mb-4">
                <div class="card-header">
                    <h6 class="mb-0">
                        <i class="fas fa-file-excel text-success"></i> Массовое управление товарами
                    </h6>
                </div>
                <div class="card-body">
                    <div class="row">
