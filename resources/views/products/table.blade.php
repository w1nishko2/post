        ...
        <div class="col-12">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h5 class="mb-1">{{ $telegramBot->bot_name }}</h5>
                            <small class="text-muted">@{{ $telegramBot->bot_username }}</small>
                        </div>
                        <div>
                            <a href="{{ route('bot.products.index', $telegramBot) }}" class="btn btn-outline-secondary me-2">
            ...
            <div class="card">
                ...
                <div class="card-body border-bottom">
                    <form method="GET" action="{{ route('bot.products.table', $telegramBot) }}" class="row g-3" accept-charset="UTF-8">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-2">
                            ...
                            <select class="form-select" id="sort_by" name="sort_by">
                                <option value="id" {{ request('sort_by', 'id') === 'id' ? 'selected' : '' }}>По ID</option>
                                ...
                                <option value="quantity" {{ request('sort_by') === 'quantity' ? 'selected' : '' }}>По количеству</option>
                        ...
                        <div class="col-md-1">
                            ...
                            <select class="form-select" id="sort_direction" name="sort_direction">
                                <option value="desc" {{ request('sort_direction', 'desc') === 'desc' ? 'selected' : '' }}>↓</option>
                        ...
                        <div class="col-12">
                            ...
                            <a href="{{ route('bot.products.table', $telegramBot) }}" class="btn btn-outline-secondary">
                                <i class="fas fa-times"></i> Сбросить
                            </a>
                            <a href="{{ route('bot.products.export-data', $telegramBot) }}" class="btn btn-success ms-2">
                ...
                <div class="card-body p-0">
                    @if($products->count() > 0)
                                        ...
                                        <tr data-product-id="{{ $product->id }}">
                                            ...
                                            <td>
                                                <div class="editable-field" 
                                                     ...
                                                     data-options="{{ json_encode($categories->map(function($cat) { return ['value' => $cat->id, 'text' => $cat->name]; })) }}">
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <form method="POST" action="{{ route('bot.products.destroy', [$telegramBot, $product]) }}" 
                                                          class="d-inline" onsubmit="return confirmDelete('{{ $product->name }}')">
                                                        @csrf
                                                        @method('DELETE')
                        ...
                        @if($products->hasPages())
                            <div class="card-footer bg-light">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="text-muted">
                                        Показано {{ $products->firstItem() }}-{{ $products->lastItem() }} из {{ $products->total() }} записей
                                    </div>
                                    <div>
                                        {{ $products->links() }}
                                    </div>
                    ...
                    @else
                        <div class="text-center py-5">
                            @if(request('search') || request('category_id') || request()->has('is_active'))
                                ...
                                <a href="{{ route('bot.products.table', $telegramBot) }}" class="btn btn-outline-primary">
