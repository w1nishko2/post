            ...
            <div class="admin-d-flex admin-justify-content-between admin-align-items-center">
                <div>
                    <h5 class="admin-mb-1">
                        ...
                        <?php echo e($telegramBot->bot_name); ?>
                ...
                <?php if($telegramBot->hasMiniApp()): ?>
                <div>
                    <a href="<?php echo e($telegramBot->getMiniAppUrl()); ?>" target="_blank" class="admin-btn admin-btn-sm admin-btn-outline-primary">
    ...
    <div class="admin-card">
        <div class="admin-card-header">
            <h5 class="admin-mb-1">
                ...
                Редактирование категории "<?php echo e($category->name); ?>"
            </h5>
...
$message = $__bag->first($__errorArgs[0]); ?> admin-is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="admin-form-group">
                    ...
                    <textarea class="admin-form-control <?php $__errorArgs = ['description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> admin-is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    <small class="admin-text-muted">
                        ...
                        <div class="admin-form-group">
                            ...
                            <div id="category-photo-dropzone" style="border: 2px dashed #cbd5e0; border-radius: 8px; padding: 1.5rem; text-align: center; background-color: #f7fafc; transition: all 0.3s ease; cursor: pointer; <?php echo e($category->photo_url ? '' : ''); ?>">
                                <i class="fas fa-cloud-upload-alt" style="font-size: 2rem; color: #4299e1; margin-bottom: 0.5rem;"></i>
                                <p style="margin-bottom: 0.5rem;"><strong><?php echo e($category->photo_url ? 'Загрузить новое изображение' : 'Перетащите изображение сюда'); ?></strong></p>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="admin-d-flex admin-gap-3">
                    ...
                    <a href="<?php echo e(route('bot.categories.index', $telegramBot)); ?>" class="admin-btn admin-btn-outline-secondary">
                        <i class="fas fa-times"></i>
                        Отмена
                    </a>
                </div>
