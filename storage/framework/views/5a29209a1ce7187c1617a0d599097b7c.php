                ...
                <div class="product-flex-item">
                    <div class="product-card" onclick="showProductDetails(<?php echo e($product->id); ?>)">
                        <div class="product-image-container">
                            ...
                            <span class="quantity-badge <?php echo e($product->quantity > 10 ? 'quantity-success' : ($product->quantity > 0 ? 'quantity-warning' : 'quantity-danger')); ?>">
                            ...
                            <div class="product-actions">
                                <div class="product-action-row">
                                    ...
                                    <div class="product-price-wrapper">
                                        <span class="product-price"><?php echo e($product->formatted_price_with_markup); ?></span>
                                    </div>
