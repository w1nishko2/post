        ...
        <div class="col-md-12">
                            ...
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-grow-1">
                                    <div class="d-flex align-items-center mb-2">
                                        <h3 class="mb-0 me-3"><?php echo e($category->name); ?></h3>
                                    ...
                                    <div class="row text-center">
                                        <div class="col-4">
                                            <div class="border rounded p-2">
                                                <h5 class="text-primary mb-1"><?php echo e($category->products->count()); ?></h5>
                                                <small class="text-muted">Всего товаров</small>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="border rounded p-2">
                                                <h5 class="text-success mb-1"><?php echo e($category->activeProducts->count()); ?></h5>
                                                <small class="text-muted">Активных товаров</small>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="border rounded p-2">
                                                <h5 class="text-info mb-1"><?php echo e($category->created_at->format('d.m.Y')); ?></h5>
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body d-flex flex-column">
                            <div class="d-grid gap-2 flex-grow-1">
                                <a href="<?php echo e(route('bot.categories.edit', [$telegramBot, $category])); ?>" class="btn btn-primary">
                                    Редактировать
                                </a>
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">
                        Товары в категории
                        <span class="badge bg-secondary ms-2"><?php echo e($category->products->count()); ?></span>
                    </h5>
                    <div>
                        <a href="<?php echo e(route('bot.products.create', $telegramBot)); ?>?category_id=<?php echo e($category->id); ?>" class="btn btn-primary btn-sm">
                            Добавить товар
                        </a>
                    </div>
                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-start mb-3">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <p class="text-success fw-bold mb-1"><?php echo e(number_format($product->price, 0, ',', ' ')); ?> ₽</p>
                                                <div class="d-flex align-items-center text-muted small">
                                                    <span class="me-2">Остаток: <?php echo e($product->quantity ?? 'Неограничен'); ?></span>
                    ...
                    <?php else: ?>
                        <div class="text-center py-5">
                            ...
                            <div class="d-flex gap-2 justify-content-center">
                                <a href="<?php echo e(route('bot.products.create', $telegramBot)); ?>?category_id=<?php echo e($category->id); ?>" class="btn btn-success">
                                    <i class="fas fa-plus"></i> Создать товар
                                </a>
                                <a href="<?php echo e(route('bot.products.index', $telegramBot)); ?>" class="btn btn-outline-primary">
