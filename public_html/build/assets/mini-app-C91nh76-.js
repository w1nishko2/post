var ue;(ue=window.Telegram)!=null&&ue.WebApp;var me,fe;const U=!!((fe=(me=window.Telegram)==null?void 0:me.WebApp)!=null&&fe.initData);let b=null,ie=!1,z=[],O=[],_=!1,k=!1;function d(e){if(!e)return"";const t={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"};return String(e).replace(/[&<>"']/g,function(n){return t[n]})}function _e(){const e=document.querySelector('meta[name="csrf-token"]');return e?e.getAttribute("content"):null}function A(e,t={}){var o,s;const n=_e();if(U&&b&&b.id)try{const a=new URL(e,window.location.origin);a.pathname.includes("/api/")&&(a.searchParams.set("tgChatId",b.id),e=a.toString())}catch(a){console.debug("Не удалось добавить tgChatId к URL:",a)}return t.method&&["POST","PUT","DELETE","PATCH"].includes(t.method.toUpperCase())&&(t.headers={"Content-Type":"application/json",Accept:"application/json",...t.headers},n&&(t.headers["X-CSRF-TOKEN"]=n)),U&&((s=(o=window.Telegram)==null?void 0:o.WebApp)!=null&&s.initData)&&(t.headers={...t.headers,"X-Telegram-Web-App-Init-Data":window.Telegram.WebApp.initData}),fetch(e,t)}function He(){var n;const e=(n=window.Telegram)==null?void 0:n.WebApp;if(!e)return null;const t=parseFloat(e.version||"0");return console.log(`[Telegram WebApp] Версия: ${e.version}`),t<6.1&&(console.warn("[Telegram WebApp] Устаревшая версия. Некоторые функции могут не работать."),console.warn("[Telegram WebApp] Рекомендуется обновить Telegram до последней версии."),setTimeout(()=>{E("Обновите Telegram для улучшенной работы приложения","warning")},3e3)),t}function pe(){if(ie)return;ie=!0;const e=setTimeout(()=>{try{const t=document.getElementById("loading"),n=document.getElementById("app");t&&(t.style.display="none"),n&&(n.style.display="block")}catch(t){console.error("Ошибка при принудительном показе приложения:",t)}},2e3);if(window.Telegram&&window.Telegram.WebApp){const t=window.Telegram.WebApp;try{const n=He();if(t.ready(),t.expand(),t.initDataUnsafe&&t.initDataUnsafe.user?(b=t.initDataUnsafe.user,N(b)):t.initData&&(b=Fe(t.initData),b&&N(b)),document.documentElement.style.setProperty("--tg-color-scheme",t.colorScheme),document.documentElement.style.setProperty("--tg-theme-bg-color",t.themeParams.bg_color||"#ffffff"),document.documentElement.style.setProperty("--tg-theme-text-color",t.themeParams.text_color||"#000000"),Ce(),n>=6.2&&typeof t.enableClosingConfirmation=="function")try{t.enableClosingConfirmation()}catch(o){console.warn("enableClosingConfirmation не поддерживается:",o)}if(n>=6.1&&t.BackButton)try{typeof t.BackButton.hide=="function"&&t.BackButton.hide()}catch{}}catch(n){console.error("Ошибка инициализации Telegram WebApp:",n),Pe("Ошибка загрузки Telegram WebApp")}}else b={id:123456789,first_name:"Тестовый",last_name:"Пользователь",username:"testuser"},N(b);try{De(),je().catch(t=>{console.error("Ошибка загрузки категорий:",t)})}catch(t){console.error("Ошибка инициализации поиска/категорий:",t)}setTimeout(()=>{try{clearTimeout(e);const t=document.getElementById("loading"),n=document.getElementById("app");t&&(t.style.display="none"),n&&(n.style.display="block"),setTimeout(()=>{try{Ae()}catch(o){console.error("Ошибка настройки модальных окон:",o)}},100),window.addEventListener("resize",ke)}catch(t){console.error("Ошибка при скрытии загрузочного экрана:",t)}},500)}function Pe(e){const t=document.createElement("div");t.className="alert alert-danger",t.style.cssText=`
    ...
    `,n.appendChild(o),window.bootstrap&&window.bootstrap.Toast?(new window.bootstrap.Toast(o).show(),o.addEventListener("hidden.bs.toast",()=>{o.remove()})):(o.style.display="block",setTimeout(()=>{o.remove()},5e3))}function Ge(){const e=document.createElement("div");return e.id="toast-container",e.className="toast-container position-fixed top-0 end-0 p-3",e.style.zIndex="9999",document.body.appendChild(e),e}function Xe(){(!CSS.supports||!CSS.supports("display","grid"))&&document.documentElement.classList.add("no-cssgrid")}function De(){const e=document.getElementById("searchInput");if(!e)return;let t;e.addEventListener("input",function(n){clearTimeout(t),t=setTimeout(()=>{V(n.target.value)},300)}),e.addEventListener("keypress",function(n){n.key==="Enter"&&V(n.target.value)}),We()}async function We(){var e;try{const t=document.getElementById("products-data");if(t)try{const s=JSON.parse(t.textContent);z=Object.values(s);return}catch(s){console.warn("Ошибка парсинга встроенных данных товаров:",s)}const n=((e=document.querySelector('meta[name="short-name"]'))==null?void 0:e.content)||window.location.pathname.split("/")[1],o=await A(`/${n}/api/products`);o.ok&&(z=await o.json())}catch(t){console.error("Ошибка при загрузке товаров:",t)}}async function je(){var e;try{const t=((e=document.querySelector('meta[name="short-name"]'))==null?void 0:e.content)||window.location.pathname.split("/")[1],n=new AbortController,o=setTimeout(()=>n.abort(),5e3),s=`/${t}/api/categories`,a=await A(s,{signal:n.signal,headers:{Accept:"application/json","Content-Type":"application/json"}});if(clearTimeout(o),a.ok&&(O=await a.json(),O.length>0)){const r=document.getElementById("categoriesContainer");r&&(r.style.display="block"),Re(O)}}catch(t){t.name!=="AbortError"&&console.error("Ошибка при загрузке категорий:",t)}}function Re(e){const t=document.getElementById("categoriesTrack");if(!t){console.error("Элемент categoriesTrack не найден");return}if(e.length===0){const s=document.getElementById("categoriesContainer");s&&(s.style.display="none");return}window.allCategoriesData=e;const n=8;t.innerHTML=e.map((s,a)=>a<n?`
            ...
            </div>`).join(""),t.querySelectorAll('.category-card[data-loaded="true"]').forEach(s=>{s.addEventListener("click",function(){const a=this.getAttribute("data-category-id"),r=this.getAttribute("data-category-name");a&&r&&j(parseInt(a),r)})}),typeof window.reinitCategoriesSwiper=="function"&&setTimeout(()=>{window.reinitCategoriesSwiper()},100)}function ye(){const e=window.categoriesSwiper;if(!e){console.warn("Swiper не инициализирован для ленивой загрузки");return}if(!e.slides||e.slides.length===0){console.warn("Swiper slides не найдены, отложенная инициализация..."),setTimeout(()=>{ye()},500);return}const t=o=>{var r;if(!o||o.getAttribute("data-loaded")==="true")return;const s=parseInt(o.getAttribute("data-index")),a=(r=window.allCategoriesData)==null?void 0:r[s];a&&(o.innerHTML=`
            <div class="card h-200">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="category-info">
    ...
    `;try{const s=document.querySelector('meta[name="short-name"]'),a=s?s.getAttribute("content"):"";if(!a)throw new Error("Short name не найден");const r=await A(`/${a}/api/search?category_id=${e}`);if(!r.ok)throw new Error(`Ошибка загрузки: ${r.status}`);const i=await r.json();if(i.length===0){o.innerHTML=`
                <div class="products-header">
            ...
            `;return}Ne(i,t);const c=document.getElementById("searchInput");c&&(c.value=""),document.body.classList.add("category-view"),setTimeout(()=>{$e()},1e3)}catch(s){console.error("Ошибка загрузки товаров категории:",s),o.innerHTML=`
            <div class="products-header">
                <h5 id="productsTitle"><i class="fas fa-folder-open me-2"></i>Категория: ${d(t)}</h5>
            </div>
            <div class="no-results">
    ...
    `}function D(){_=!1,k=!1;const e=document.getElementById("backButton");e&&(e.style.display="none",e.classList.remove("show"));const t=document.getElementById("searchInput");t&&(t.value=""),document.body.classList.remove("category-view"),window.location.reload()}function S(e){return Number(e).toLocaleString("ru-RU",{minimumFractionDigits:0,maximumFractionDigits:2})}function $(e){return!e||e.startsWith("http://")||e.startsWith("https://")||e.startsWith("/")?e:"/"+e}function Ye(e,t){const n=[];for(let o=0;o<=t.length;o++)n[o]=[o];for(let o=0;o<=e.length;o++)n[0][o]=o;for(let o=1;o<=t.length;o++)for(let s=1;s<=e.length;s++)t.charAt(o-1)===e.charAt(s-1)?n[o][s]=n[o-1][s-1]:n[o][s]=Math.min(n[o-1][s-1]+1,n[o][s-1]+1,n[o-1][s]+1);return n[t.length][e.length]}function Y(e,t){const n=e.length>t.length?e:t,o=e.length>t.length?t:e;if(n.length===0)return 100;const s=Ye(n,o),a=(n.length-s)/n.length*100;return Math.max(0,a)}function Q(e,t){const n=e.toLowerCase(),o=t.toLowerCase();if(o.includes(n))return 100;const s=Y(n,o),a=o.split(/\s+/);let r=0;a.forEach(c=>{if(c.length>=2){const l=Y(n,c);r=Math.max(r,l)}});let i=0;if(n.length>=3)for(let c=0;c<=o.length-n.length;c++){const l=o.substring(c,c+n.length),m=Y(n,l);i=Math.max(i,m)}return Math.max(s,r,i)}let x=!1;function ne(e){se(e,1)}function B(){fetch("/cart/count").then(e=>e.json()).then(e=>{const t=document.getElementById("cart-counter"),n=document.getElementById("cart-float");t&&n&&(e.count>0?(t.textContent=e.count,t.classList.remove("hidden"),n.classList.remove("hidden"),t.style.animation="none",setTimeout(()=>{t.style.animation="cart-counter-pulse 2s infinite"},50)):(t.classList.add("hidden"),n.classList.add("hidden")))}).catch(e=>{console.error("Ошибка получения счетчика корзины:",e);const t=document.getElementById("cart-float");t&&t.classList.add("hidden")})}async function oe(e){var t;try{const n=document.getElementById("productModal"),o=document.getElementById("productModalTitle"),s=document.getElementById("productModalBody"),a=document.getElementById("productModalFooter");if(!n||!s||!a){console.error("Элементы модального окна не найдены");return}n.classList.add("show"),n.style.display="block",document.body.style.overflow="hidden",o.textContent="Загрузка...",s.innerHTML=`
            <div class="loading-content">
                <div class="loading-spinner"></div>
                <div class="loading-text">Загрузка товара...</div>
            </div>
        `,a.style.display="none";const r=(t=document.querySelector('meta[name="short-name"]'))==null?void 0:t.getAttribute("content");if(!r)throw new Error("Short name не найден");const i=await A(`/${r}/api/products/${e}`);if(!i.ok)throw new Error(`HTTP error! status: ${i.status}`);const c=await i.json();window.cachedProductsData||(window.cachedProductsData={}),window.cachedProductsData[e]=c,Qe(c,s,o,a)}catch(n){console.error("Ошибка при загрузке данных товара:",n),u("Ошибка при загрузке данных товара","error")}}function Qe(e,t,n,o){n.textContent="",t.innerHTML=`
        <div class="row g-4">
    ...
    `,e.isAvailable&&e.quantity>0&&setTimeout(()=>{const s=e.price_with_markup||e.price;Ee(e.id,1,s,e.quantity)},100),setTimeout(()=>{Le()},150)}function he(){const e=document.getElementById("productPanel"),t=document.getElementById("panelBackdrop"),n=document.getElementById("productPanelFooter");t&&t.classList.remove("show"),e&&e.classList.remove("show"),n&&(n.style.display="none"),document.body.style.overflow="auto"}function ge(e){let t="secondary";return e.availability_status==="В наличии"?t="success":e.availability_status==="Заканчивается"?t="warning":e.availability_status==="Нет в наличии"&&(t="danger"),`<span class="badge bg-${t} shadow-sm">${d(e.availability_status||"")}</span>`}function Ue(e,t){const n=document.getElementById(`quantity-${e}`);if(!n)return;const o=parseInt(n.value)||1,s=Math.max(1,Math.min(parseInt(n.max),o+t));n.value=s,we(e,s),ve(e,s),y("light")}function ze(e){const t=document.getElementById(`quantity-${e}`);if(!t)return;const n=parseInt(t.value),o=parseInt(t.max);isNaN(n)||n<1?t.value=1:n>o&&(t.value=o,u(`Максимальное количество: ${o} шт.`,"warning"));const s=parseInt(t.value);we(e,s),ve(e,s)}function we(e,t){const n=window.cachedProductsData?window.cachedProductsData[e]:null;if(n){const o=n.price*t,s=new Intl.NumberFormat("ru-RU",{style:"currency",currency:"RUB"}).format(o),a=document.getElementById(`totalPrice-${e}`);a&&(a.textContent=s)}}function ve(e,t){const n=document.getElementById(`decreaseBtn-${e}`),o=document.getElementById(`increaseBtn-${e}`),s=document.getElementById(`quantity-${e}`);if(n&&(n.disabled=t<=1),o&&s){const a=parseInt(s.max);o.disabled=t>=a}}function se(e,t){F(!0);const n=new FormData;n.append("_token",document.querySelector('meta[name="csrf-token"]').getAttribute("content")),n.append("quantity",t),fetch(`/cart/add/${e}`,{method:"POST",body:n}).then(o=>o.json()).then(o=>{F(!1),o.success?(u(`Товар добавлен в корзину (${t} шт.)!`),B(),be(),y("success")):(J(!0),u(o.message||"Ошибка при добавлении товара","error"),y("error"))}).catch(o=>{F(!1),J(!0),console.error("Ошибка при добавлении товара в корзину:",o),u("Ошибка при добавлении товара в корзину","error"),y("error")})}function Ve(){Te()}function y(e="light"){var t;try{const n=(t=window.Telegram)==null?void 0:t.WebApp,o=parseFloat((n==null?void 0:n.version)||"0");n&&o>=6.1&&n.HapticFeedback&&typeof n.HapticFeedback.impactOccurred=="function"&&n.HapticFeedback.impactOccurred(e)}catch{}}function Je(e=!0,t=0){const n=document.getElementById("cart-float"),o=document.getElementById("cart-counter");!n||!o||(e&&t>0?(o.textContent=t,o.classList.remove("hidden"),n.classList.remove("hidden"),o.style.animation="cart-counter-pulse 2s infinite"):(o.classList.add("hidden"),n.classList.add("hidden")))}function be(){const e=document.querySelector(".cart-float-btn"),t=document.querySelector(".cart-float-btn .fa-shopping-cart");e&&t&&(e.style.transform="translateY(-4px) scale(1.1)",e.style.boxShadow="0 12px 32px rgba(16, 185, 129, 0.5)",t.style.transform="rotate(-15deg) scale(1.2)",setTimeout(()=>{e.style.transform="",e.style.boxShadow="",t.style.transform=""},300),y("medium"))}function F(e=!0){const t=document.querySelector(".cart-float-btn");t&&(e?(t.classList.add("loading"),t.setAttribute("aria-busy","true")):(t.classList.remove("loading"),t.setAttribute("aria-busy","false")))}function J(e=!0){const t=document.querySelector(".cart-float-btn");t&&e&&(t.style.background="linear-gradient(135deg, #ef4444 0%, #dc2626 100%)",setTimeout(()=>{t.style.background=""},2e3))}function re(e){return(e.is_active!==void 0?e.is_active:e.isAvailable)?e.quantity<=0?'<div class="product-status"><span class="status-badge status-out-of-stock">Нет в наличии</span></div>':e.quantity<=5?`<div class="product-status"><span class="status-badge status-limited">Осталось ${e.quantity}</span></div>`:'<div class="product-status"><span class="status-badge status-available">В наличии</span></div>':'<div class="product-status"><span class="status-badge status-inactive">Недоступен</span></div>'}function Ke(e){return"bg-success"}function Ze(e){return e<=0?"Нет в наличии":`${e} шт.`}function et(e,t){var r;const n=document.getElementById(`modal-quantity-${e}`);if(!n)return;const o=parseInt(n.textContent)||1,s=Math.max(1,o+t),a=(r=window.cachedProductsData)==null?void 0:r[e];if(a){const i=Math.min(a.quantity,99),c=Math.min(s,i),l=a.price_with_markup||a.price;Ee(e,c,l,a.quantity)}}function Ee(e,t,n,o){const s=document.getElementById(`modal-quantity-${e}`),a=document.getElementById(`modal-decrease-${e}`),r=document.getElementById(`modal-increase-${e}`),i=document.getElementById(`modal-total-price-${e}`);if(s&&(s.textContent=t),a&&(a.disabled=t<=1),r&&(r.disabled=t>=o),i&&n){const c=t*n;i.textContent=`Итого: ${S(c)} ₽`}}function tt(e){const t=document.getElementById(`modal-quantity-${e}`),n=t&&parseInt(t.textContent)||1;se(e,n);const o=document.getElementById("productModal");if(o){const s=bootstrap.Modal.getInstance(o);s&&s.hide()}}function Te(){try{const e=document.getElementById("cartModal"),t=document.getElementById("cartModalBody"),n=document.getElementById("cartModalFooter");if(!e||!t){console.error("Элементы модального окна корзины не найдены");return}e.classList.add("show"),e.style.display="block",document.body.style.overflow="hidden",t.innerHTML=`
        ...
        `,n.style.display="none",fetch("/cart",{method:"GET",headers:{"Content-Type":"application/json","X-Requested-With":"XMLHttpRequest"}}).then(o=>o.json()).then(o=>{o.success&&o.items&&o.items.length>0?Ie(o.items,o.total_amount):(t.innerHTML=`
            ...
            `,n.style.display="none"})}catch(e){console.error("Ошибка при загрузке корзины:",e),u("Ошибка при загрузке корзины","error")}}function Ie(e,t){const n=document.getElementById("cartModalBody"),o=document.getElementById("cartModalFooter");if(!n||!o)return;if(!e||e.length===0){n.innerHTML=`
